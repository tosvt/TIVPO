...
<p>Для тестирование было выбрано web-приложение https://ithillel.ua/. На нем можно регистрироваться и проходить курсы по программированию в различных областях.</p>
<h2>Результат тестирования с использованием Selenium IDE и Selenium WebDriver или аналогов</h2>
<p>В ходе тестирования, было написано два теста, первый проверяет на тот ли сайт мы зашли, второй - возможность зарегистрироваться на курс (дудос машина для их приемника заявок)</p>
